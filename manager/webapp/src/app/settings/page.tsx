...
const initialNotifications = [
  { id: 1, title: 'Settings Loaded', message: 'Settings page loaded successfully', time: '17:50', type: 'success' as const, read: false },
];
      ...
      <div className="p-6">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="grid grid-cols-2 w-[400px] mb-6">
            ...
            <TabsTrigger value="constants">Global Constants</TabsTrigger>
          </TabsList>
